...
<html>
<head>
<title>Home Security Articles, Home Safety Topics | ADT Security Services</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="home security articles, home safety topics, home safety information, home safety resources, home security stories, home safety trends, personal safety articles, child safety articles, fire prevention articles,  adt home security " />
			...
			<div class="banner-nav">
				...
				<ul class="nav1" style="padding-top:1em;">
					...
					<li><a href="#" data-hover="Services" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">LEARNING CENTRE
						<span class="caret"></span></a>
						<ul class="dropdown-menu">
                        <li><a href="index.php">LEARNING CENTRE</a></li>
	...
	<div class="blog-page">
		<div class="container">
			<div class="blog-pag">
				<div class="blog-page-grids">
					<div class="blog-page-grid">
						<h3><a href="#" style="color:#C93D3D;">Security Topics</a></h3>
						<p>The more you know about home security, the better prepared you are! Give yourself peace of mind and review these home safety topics and articles. Discover the latest on false alarm reductions, home safety basics, and security technologies.</p>
					</div>
				...
				<div class="blog-page-grids-bottom">
					<div class="blog-page-grids-bot">
						<a href="false-alarm-reduction.php"><img src="../images/ADT-Winnipeg-..jpg" alt=" " style="width:100%;" class="img-responsive" /></a>
					</div>
					<div class="blog-page-grids-bot1">
						<a href="false-alarm-reduction.php"><h4>False Alarm Reduction</h4></a>
						
							<P>False alarms are distracting for homeowners, their neighbors, and emergency personnel. Discover steps you can take to prevent false alarms.</P><br>
						<div class="more" >
							<a href="false-alarm-reduction.php">Learn More</a>
						</div>
					</div>
					<div class="clearfix"> </div>
				</div>
			...
			<div class="blog-pag">
				...
				<div class="blog-page-grids-bottom">
					<div class="blog-page-grids-bot">
						<a href="home-safety-basics.php"><img src="../images/Choosing-the-Best-Home-Security-Camera-System.jpg" alt=" " style="width:100%;" class="img-responsive" /></a>
					</div>
					<div class="blog-page-grids-bot1">
					<a href="home-safety-basics.php">	<h4>Home Safety Basics</h4></a>
						
						<P>Protecting your family and your home are critical. Review our home safety basics and make sure you're equipped with the best knowledge.</P><br>
						<div class="more">
							<a href="home-safety-basics.php">Learn More</a>
						</div>
					</div>
					<div class="clearfix"> </div>
			...
			<div class="blog-pag">
				...
				<div class="blog-page-grids-bottom">
					<div class="blog-page-grids-bot">
						<a href="technology-security.php"><img src="../images/adt_pulse_home_automation.jpg" alt=" " style="width:100%;" class="img-responsive" /></a>
					</div>
					<div class="blog-page-grids-bot1">
						<a href="technology-security.php"><h4>Technology & Security</h4></a>
						
						<P>Today’s home security systems are equipped with the latest and greatest technology, allowing us to enjoy remote access, home automation and more.</P><br>
						<div class="more">
							<a href="technology-security.php">Learn More</a>
						</div>
					</div>
					<div class="clearfix"> </div>
				</div>
