...
<html>
<head>
<title>Current Home Security Promotions  | ADT Security Services</title>
<!-- for-mobile-apps -->
			...
			<div class="blog-pag">
				<div class="blog-page-grids">
					<div class="blog-page-grid">
						<h3><a href="#" style="color:#C93D3D;">Current Promotions</a></h3><br>
						<p>Don’t miss out on our latest promotions! ADT is the leading company for home security, and we want to protect your home too. See why safety and security is affordable, and provides peace of mind.</p>
                        <br>
                        <div style="width:750px; height:300px; background-image:url(images/2716f4004bb2b717b983bff3b528f24c.jpg); background-size:100% 100%; border:px solid #ccc;">
                        <h3 style="color:#1c5caa; padding:15px;">Free Security Review</h3>
                        <p style="padding:15px;">Get a FREE security and fire system analysis by <br>
our authorized Residential resale representative.</p>
 <h3 style="color:#C00; padding:15px;">CALL US NOW<br>
416 659 7381</h3>
<div class="more" style="margin-top:30px;  margin-left:15px;">
							<a href="contact.html" style="background:#1c5caa;">Learn More</a>
						</div>
                        </div>
                        
                        <div style="width:750px; height:300px; background-image:url(images/4746b3004bb2b717b986bff3b528f24c.jpg); margin-top:10px; background-size:100% 100%; border:px solid #ccc;">
                        
                         <h3 style="color:#1c5caa; padding:15px; float:right;">Home Security Monitoring</h3>
                        <p style="padding:15px; float:right; clear:both;">Discover the affordable measures you can<br>
take to improve your family's home security.</p>
 
<div class="more" style="margin-top:30px; float:right; clear:both;  margin-right:15px;">
							<a href="solutions/home-security-package.php" style="background:#1c5caa;">Learn More</a>
						</div>
