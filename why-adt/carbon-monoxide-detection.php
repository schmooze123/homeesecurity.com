...
<html>
<head>
<title>Carbon Monoxide Detection: Home Security Reviews | ADT Security Services</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="carbon monoxide detection,  carbon monoxide alarm, smoke alarms, carbon monoxide poisoning,  carbon monoxide poisoning symptoms, home security reviews" />
...
.single .container .single-right p span {
	padding-bottom:0;
	margin-bottom:0;
}
</style>
		...
		<div class="container">
			...
			<div class="banner-nav">
					...
					<li><a href="#" data-hover="Services" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">WHY CHOOSE ADT?
						<span class="caret"></span></a>
						<ul class="dropdown-menu">
                        <li><a href="index.php">WHY CHOOSE ADT?</a></li>
							<li><a href="../solutions/24hr-monitoring.php">24 Hour Monitoring</a></li>
							<li><a href="home-security-reviews.php">ADT Customer Stories</a></li>
							<li><a href="adt-guarantees.php">ADT's Gurantees</a></li>
							<li><a href="adt-is-always-there.php">Always There Promise</a></li>
...
<!-- single -->
	...
	<div class="container">
		...
		<div class="single-left">
			<img src="../images/JuanitaRaburn-lg.jpg" alt=" " style="margin-top:2em;" class="img-responsive" />
			
		</div>
		<div class="single-right">
			<h3>Juanita Raburn, Louisiana</h3>
			<p>At 5 a.m. on the icy morning of February 12th, Coushatta resident Juanita Raburn gets a call from ADT Security Dispatch Operator Gary Yacks. Her alarm had gone off and woke her up. After losing power, Raburn's outside generator kicked on but it was installed too close to her home, and began pumping deadly levels of carbon monoxide inside. She had a terrible headache, which is one of the symptoms. His voice, calling from over 700 miles away in Knoxville, TN, was the first one Raburn heard after her detector sounded. <br><br>

"It's what they call the silent killer. You can't smell it and you really don't know it's there, especially if you're asleep," says Chief Shane Felts with the Red River Parish Fire Department, whose first responders were at Raburn's home within minutes. Thanks to Raburn's carbon monoxide detector and the quick actions of others, she's here to tell her story.
<br><br>
According to the CDC, more than 400 Americans die every year from unintentional carbon monoxide poisoning, and another 20,000 visit the emergency room. The most common symptoms of CO poisoning include headache, dizziness, weakness, chest pain, nausea, and vomiting.
			</p>
